defmodule Phoenix5280.Fitbit do
  @moduledoc """
  ...
  """
  def client_id do
    Application.get_env(:phoenix5280, :fitbit)[:fitbit_client_id] ||
  ...
  def client_secret do
    Application.get_env(:phoenix5280, :fitbit)[:client_secret] ||
  ...
  """
  def token do
    Application.get_env(:phoenix5280, :fitbit)[:token] ||
