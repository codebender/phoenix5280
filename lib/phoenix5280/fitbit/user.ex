defmodule Phoenix5280.Fitbit.User do
  ...
  defp parse_user(user) do
    %Phoenix5280.Fitbit.User{
      about_me: user["aboutMe"],
      avatar: user["avatar"],
      avatar150: user["avatar150"],
      city: user["city"],
      country: user["country"],
      date_of_birth: Utils.display_date(user["dateOfBirth"]),
